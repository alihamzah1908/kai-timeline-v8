...
-- ----------------------------
-- Sequence structure for trx_timeline_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "auth"."trx_timeline_id_seq";
CREATE SEQUENCE "auth"."trx_timeline_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
...
INSERT INTO "auth"."mapping_type" VALUES (10, 23, 'public.trx_sp3.proses_st', 'PROSES_URKS', 'Undangan RKS', NULL, NULL, NULL, NULL);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"auth"."trx_timeline_id_seq"', 8, true);
