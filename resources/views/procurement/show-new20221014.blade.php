                ...
                <div class="card-body">
                    ...
                    <div id="smartwizard-arrows" class="sw-main sw-theme-arrows">
                        ...
                        <ul class="nav nav-tabs step-anchor">
                            ...
                            <li class="nav-item ucp"><a href="#sw-arrows-step-9" class="nav-link">Pengumuman Pemenang<small class="d-block">Step description</small></a></li>
                            <li class="nav-item pcp"><a href="#sw-arrows-step-10" class="nav-link">Usulan dan Penetapan Calon Pemenang<small class="d-block">Step description</small></a></li>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table datatable-pagination" id="tabel-data" width="100%">
                                                ...
                                                <tbody style="vertical-align: top">
                                                    ...
                                                    'a.tanggal_submit_harga','a.file_teknis')
                                                    ->where('a.sp3_id', request()->id)
                                                    ->join('public.vendor as b','a.vendor_code','b.vendor_code')
                                                    ->get();
                                                    @endphp
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ asset('file/sp3/'. $doc->file_teknis) }}" target="_blank">
                                                        ...
                                                        <td>
                                                            <a href="{{ asset('file/sp3/'. $doc->file_harga) }}" target="_blank">
                                                                Dokumen Penawaran File.pdf <img src="{{ asset('assets/images/preview.png') }}" alt="" height="25" />
                                                            </a>
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 d-flex justify-content-end">
                                                    <button type="button" class="btn btn-primary btn-sm btn-rounded approve" data-bind="{{ $data->proses_st }}"><i class="uil uil-check"></i> Approve</button>
                                                    <button type="button" class="btn btn-warning btn-sm btn-rounded reject ml-1"><i class="uil uil-multiply"></i> Reject</button>
                                                    <button type="button" class="btn btn-warning btn-sm btn-rounded reject ml-1" data-status="gagal_lelang"><i class="uil uil-multiply"></i> Gagal Lelang</button>
                                                </div>
                                            </div>
                                        </div>
        ...
        $('body').on('click', '.sw-btn-next', function(e) {
            if (status == 'PROSES_DRKS') {
                ...
                if (metode == 3) {
                    ...
                    $('.calon-tender').removeClass('active')
                    Swal.fire({
                        title: undangan.length > 0 ? 'Are you sure save Draft RKS ?' : 'Are you sure save Undangan RKS',
                        // text: 'Your procurement are send to contract!',
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
